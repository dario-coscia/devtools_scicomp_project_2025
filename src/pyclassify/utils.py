...
@profile
def distance_numpy(point1: numpy.ndarray, point2: numpy.ndarray) -> float:
    """
    Calculates and returns the square of the Euclidean distance between two points.

    Args:
    - point1 (np.ndarray): The first point as a numpy array of coordinates.
    - point2 (np.ndarray): The second point as a numpy array of coordinates.
